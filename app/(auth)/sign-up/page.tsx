    ...
    <>
      <div className="sm:px-4">
        <div className="min-h-screen flex flex-col items-center justify-center">
          <div className="flex items-center gap-4 bg-white max-w-7xl p-4 m-4 shadow-lg rounded-md">
            <div className="md:max-w-md w-full px-4 py-4">
              <form>
                ...
                <div>
                  ...
                  <div className="relative flex items-center">
                    <Input
                      ...
                      type="text"
                      required
                      className="w-full text-slate-800 text-sm border-b border-slate-300 focus:border-blue-600 pl-4 pr-8 py-3 outline-none"
                ...
                <div className="mt-8">
                  <Button
                    type="button"
                    className="w-full shadow-lg py-3 text-sm font-medium tracking-wide rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none"
                  >
                    Sign Up
                  </Button>
                </div>
