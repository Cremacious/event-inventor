    ...
    <>
      <div className="max-sm:px-4">
        <div className="min-h-screen flex flex-col items-center justify-center">
          <div className="grid md:grid-cols-2 items-center gap-4 bg-white max-md:gap-8 max-w-6xl max-md:max-w-lg w-full p-4 m-4 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md">
            <div className="md:max-w-md w-full px-4 py-4">
              <form>
                <div className="mb-12">
                  ...
                  <p className="text-sm mt-6 text-slate-800">
                ...
                <div>
                  <label className="text-slate-800 text-xs font-medium block mb-2">
                    Email
                  </label>
                  <div className="relative flex items-center">
                    <Input
                      ...
                      type="text"
                      required
                      className="w-full text-slate-800 text-sm border-b border-slate-300 focus:border-blue-600 pl-2 pr-8 py-3 outline-none"
